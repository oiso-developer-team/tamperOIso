...
(function() {
    ...
    function luogu(){
        // 获取 meta http-equiv="Content-Security-Policy"标签
        ...
        document.addEventListener('keydown', function(event) {
            if (event.keyCode == 32 && event.shiftKey) {
                ...
                suggestionContainer.style.width = '550px';
                suggestionContainer.style.borderRadius = '0 0 5px 5px';
                suggestionContainer.style.overflow = 'hidden';
                suggestionContainer.style.backgroundColor = '#fff';
                suggestionContainer.style.boxShadow = '0 0 10px rgba(0, 0, 0, 0.2)';
                suggestionContainer.style.zIndex = '999';
                suggestionContainer.style.transition = '0.25s';
                suggestionContainer.style.webkitBackdropFilter = 'blur(30px) saturate(1.25)';
                suggestionContainer.style.backdropFilter = 'blur(30px) saturate(1.25)';
                suggestionContainer.style.boxShadow = 'rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px';
                suggestionContainer.style.webkitBackdropFilter = 'blur(30px) saturate(1.25)';
                suggestionContainer.style.backdropFilter = 'blur(30px) saturate(1.25)';
                suggestionContainer.style.boxShadow = 'rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px';
                // 如果系统是暗色模式，则背景是灰色的
